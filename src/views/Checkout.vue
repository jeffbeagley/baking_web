      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
              <router-link to="/"><a href="#">Home</a></router-link> <span class="mx-2 mb-0">/</span>
              <router-link to="/cart"><a href="#">Cart</a></router-link> <span class="mx-2 mb-0">/</span>
...
export default {
    ...
    data () {
        return {
            stripeKey: 'pk_test_DfgDiyZYdcyqw9lJdmZ0ycyC',
